...
function PANEL:AddText( txt, color )
	...
	if( string.Left( txt , 1 ) == "#" and not color ) then color = GAMEMODE.DeathNoticeDefaultColor end -- localised ent death
	if( GAMEMODE.DeathNoticeTextColor and not color ) then color = GAMEMODE.DeathNoticeTextColor end -- something else
